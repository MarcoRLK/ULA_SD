...
HD_PWD='C:/Users/Marco/Google Drive/Engenharia/SD1/PED/ULA_2/ULA_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ULA_PED.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ULA_PED.tcl
