...
HD_PWD='C:/Users/Marco/Google Drive/Engenharia/SD1/PED/ULA_2/ULA_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ULA_PED.vdi -applog -m64 -messageDb vivado.pb -mode batch -source ULA_PED.tcl -notrace
