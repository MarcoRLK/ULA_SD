...
HD_PWD='C:/Users/Marco/prerel6/prerel6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log HEX_to_SSEG.vdi -applog -m64 -messageDb vivado.pb -mode batch -source HEX_to_SSEG.tcl -notrace
