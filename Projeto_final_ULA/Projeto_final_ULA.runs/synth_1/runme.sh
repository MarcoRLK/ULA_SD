...
HD_PWD='C:/Users/Marco/Projeto_final_ULA/Projeto_final_ULA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ULA.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ULA.tcl
