...
HD_PWD='C:/Users/Marco/Projeto_final_ULA/Projeto_final_ULA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ULA.vdi -applog -m64 -messageDb vivado.pb -mode batch -source ULA.tcl -notrace
