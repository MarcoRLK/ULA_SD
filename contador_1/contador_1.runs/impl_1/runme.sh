...
HD_PWD='C:/Users/lucas/Desktop/lab_07/contador_1/contador_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log contador_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source contador_1.tcl -notrace
