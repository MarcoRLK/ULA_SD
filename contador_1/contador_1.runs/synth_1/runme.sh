...
HD_PWD='C:/Users/lucas/Desktop/lab_07/contador_1/contador_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log contador_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source contador_1.tcl
